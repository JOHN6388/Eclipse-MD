...
const interactiveButtons = [
  {
    ...
    buttonParamsJson: JSON.stringify({
      ...
      merchant_url: "https://github.com/horlapookie/Eclipse-MD"
    })
  },
  {
    name: "cta_url", 
    buttonParamsJson: JSON.stringify({
      display_text: "🆘 Support Website",
      url: "http://www.eclipse-support.zone.id",
      merchant_url: "http://www.eclipse-support.zone.id"
    })
  },
  {
    name: "cta_url",
    buttonParamsJson: JSON.stringify({
      ...
      url: "https://t.me/horlapookie",
      merchant_url: "https://t.me/horlapookie"
    })
  },
  {
    name: "quick_reply",
    buttonParamsJson: JSON.stringify({
      display_text: "🤖 AI Commands",
      id: `${prefix}aimodels`
    })
  },
  {
      ...
      const menuMessage = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            thumbnailUrl: mediaUrls.menuImage,
